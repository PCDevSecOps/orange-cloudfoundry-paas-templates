...
ln -sf ../../../../shared-operators/shield/add-shield-import-systems-mysql-errand-operators.yml 40-shieldv8-add-shield-import-systems-mysql-errand-operators.yml
...
ln -sf ../../../../shared-operators/shield/add-shield-agent-job-operators.yml 41-shieldv8-add-shield-agent-job-operators.yml
ln -sf ../../../../shared-operators/shield/add-shield-agent-proxy-operators.yml 41-shieldv8-add-shield-agent-proxy-operators.yml
ln -sf ../../../../shared-operators/shield/add-shield-import-systems-fs-errand-operators.yml 41-shieldv8-add-shield-import-asystems-fs-errand-operators.yml
ln -sf ../../../../shared-operators/shield/add-shield-import-members-errand-operators.yml 41-shieldv8-add-shield-import-members-errand-operators.yml
ln -sf ../../../../shared-operators/shield/add-shield-import-policies-errand-operators.yml 41-shieldv8-add-shield-import-policies-errand-operators.yml
ln -sf ../../../../shared-operators/shield/add-shield-import-storage-errand-operators.yml 41-shieldv8-add-shield-import-storage-errand-operators.yml
