...
#--- Git bosh releases
uploadRelease "git" "credhub-importer" "https://github.com/cloudfoundry-community/credhub-importer-boshrelease" "1.1.0" "1.1.0"
uploadRelease "git" "squid" "https://github.com/cloudfoundry-community/squid-boshrelease" "1.0.1" "v1.0.1"
uploadRelease "git" "helm-kubectl" "https://github.com/orange-cloudfoundry/helm-kubectl-boshrelease" "22" "22.0"
