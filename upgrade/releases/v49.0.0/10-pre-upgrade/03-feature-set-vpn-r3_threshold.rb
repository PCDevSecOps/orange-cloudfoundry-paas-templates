...
def feature_set_vpn_r3_threshold(secrets_dir)
  ...
  if ! max_upload_speed_kbps
    ...
    shared_secrets_yaml["secrets"]['multi_region']['region_3']['max_upload_speed_kbps']=10000
  ...
  if ! max_download_speed_kbps
    ...
    shared_secrets_yaml["secrets"]['multi_region']['region_3']['max_download_speed_kbps']=10000
    update_required = true
  end
