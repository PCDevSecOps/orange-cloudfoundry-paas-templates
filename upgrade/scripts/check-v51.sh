...
checkAccess "401" "https" "docker.jcr-k8s.${OPS_DOMAIN}/v2/"  #--- deploy-k8s-jcr legacy access (DNS alias must be present in ops pki cert)
...
checkAccess "404" "https" "jcr.${OPS_DOMAIN}"               #--- Check that jcr bosh is stopped
...
checkAccess "404" "https" "elpaaso-gitlab.${OPS_DOMAIN}"    #--- Check that gitlab bosh is stopped
