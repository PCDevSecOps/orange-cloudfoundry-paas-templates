...
${RM_CMD} ${ROOT_DIR}/ops-depls/cf-apps-deployments/osb-cmdb-broker/template/post-deploy.sh
${RM_CMD} ${ROOT_DIR}/ops-depls/cf-apps-deployments/overview-broker/README.md
