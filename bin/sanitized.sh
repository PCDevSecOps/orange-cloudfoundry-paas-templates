...
${RM_CMD} ${ROOT_DIR}/ops-depls/cf-apps-deployments/osb-reverse-proxy-1/template/osb-reverse-proxy-1_manifest-tpl.yml
${RM_CMD} ${ROOT_DIR}/ops-depls/cf-apps-deployments/osb-reverse-proxy-2/template/osb-reverse-proxy-2_manifest-tpl.yml
${RM_CMD} ${ROOT_DIR}/ops-depls/cf-apps-deployments/osb-reverse-proxy-3/template/osb-reverse-proxy-3_manifest-tpl.yml
${RM_CMD} ${ROOT_DIR}/ops-depls/cf-apps-deployments/osb-reverse-proxy-4/template/osb-reverse-proxy-4_manifest-tpl.yml
${RM_CMD} ${ROOT_DIR}/ops-depls/cf-apps-deployments/osb-reverse-proxy-5/template/osb-reverse-proxy-5_manifest-tpl.yml
${RM_CMD} ${ROOT_DIR}/ops-depls/cf-apps-deployments/osb-reverse-proxy/template/osb-reverse-proxy_manifest-tpl.yml
${RM_CMD} ${ROOT_DIR}/ops-depls/cf-apps-deployments/overview-broker/template/common-post-deploy.sh
${RM_CMD} ${ROOT_DIR}/zz-docs/release-notes/V49_0_1.md
...
${RM_CMD} ${ROOT_DIR}/coab-depls/terraform-config/spec/redis-extended-service-broker.tf
...
echo "Sanitize v50 develop"
${RM_CMD} ${ROOT_DIR}/master-depls/prometheus-exporter-ops/template/2-bosh-exporter-operators.yml
${RM_CMD} ${ROOT_DIR}/master-depls/prometheus-exporter-ops/template/2-cf-exporter-operators.yml
${RM_CMD} ${ROOT_DIR}/master-depls/prometheus-exporter-ops/template/2-firehose-exporter-operators.yml
