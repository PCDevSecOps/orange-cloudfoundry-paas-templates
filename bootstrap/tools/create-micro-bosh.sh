...
export BOSH_VERSION=$(getValue ${MICRO_DEPLS_VERSION_FILE} /releases/bosh/version)
export BOSH_SHA1=$(getValue ${MICRO_DEPLS_VERSION_FILE} /releases/bosh/sha1)
export BPM_VERSION=$(getValue ${MICRO_DEPLS_VERSION_FILE} /releases/bpm/version)
export BPM_SHA1=$(getValue ${MICRO_DEPLS_VERSION_FILE} /releases/bpm/sha1)
export UAA_VERSION=$(getValue ${MICRO_DEPLS_VERSION_FILE} /releases/uaa/version)
export UAA_SHA1=$(getValue ${MICRO_DEPLS_VERSION_FILE} /releases/uaa/sha1)
export OS_CONF_VERSION=$(getValue ${MICRO_DEPLS_VERSION_FILE} /releases/os-conf/version)
export OS_CONF_SHA1=$(getValue ${MICRO_DEPLS_VERSION_FILE} /releases/os-conf/sha1)
export BOSH_DNS_VERSION=$(getValue ${MICRO_DEPLS_VERSION_FILE} /releases/bosh-dns/version)
export BOSH_DNS_SHA1=$(getValue ${MICRO_DEPLS_VERSION_FILE} /releases/bosh-dns/sha1)
export BBR_VERSION=$(getValue ${MICRO_DEPLS_VERSION_FILE} /releases/backup-and-restore-sdk/version)
export BBR_SHA1=$(getValue ${MICRO_DEPLS_VERSION_FILE} /releases/backup-and-restore-sdk/sha1)
export NODE_EXPORTER_VERSION=$(getValue ${MICRO_DEPLS_VERSION_FILE} /releases/node-exporter/version)
export NODE_EXPORTER_SHA1=$(getValue ${MICRO_DEPLS_VERSION_FILE} /releases/node-exporter/sha1)
export GENERIC_SCRIPTING_VERSION=$(getValue ${MICRO_DEPLS_VERSION_FILE} /releases/generic-scripting/version)
export GENERIC_SCRIPTING_SHA1=$(getValue ${MICRO_DEPLS_VERSION_FILE} /releases/generic-scripting/sha1)
