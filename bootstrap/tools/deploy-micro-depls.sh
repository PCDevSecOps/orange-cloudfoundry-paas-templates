...
uploadBoshReleases() {
  ...
  uploadRelease "http" "docker" "docker" "https://bosh.io/d/github.com/cloudfoundry-incubator/docker-boshrelease?v="
  ...
  uploadRelease "http" "routing" "routing" "https://bosh.io/d/github.com/cloudfoundry/routing-release?v="
  ...
  uploadRelease "http" "concourse" "concourse" "https://bosh.io/d/github.com/concourse/concourse-bosh-release?v=" "5.8.1"
