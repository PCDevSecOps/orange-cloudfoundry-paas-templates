...
DO_NOT_STOP_DEPLS="cfcr cfcr-persistent-worker credhub-ha dns-recursor docker-bosh-cli intranet-interco-relay internet-proxy jcr openldap ops-routing logsearch logsearch-ops io-bench weave-scope"
