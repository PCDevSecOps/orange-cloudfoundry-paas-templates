...
resource "cloudfoundry_buildpack" "php-buildpack-offline" {
  ...
  path = "http://private-s3.internal.paas:9000/cached-buildpacks/php_buildpack-cached-v4.4.8.zip"
  position = 33
  locked = false
  enabled = true
}
...
resource "cloudfoundry_buildpack" "static-buildpack-offline" {
  ...
  path = "http://private-s3.internal.paas:9000/cached-buildpacks/staticfile_buildpack-cached-v1.5.4.zip"
  position = 34
  locked = false
  enabled = true
}
...
resource "cloudfoundry_buildpack" "ruby-buildpack-offline" {
  ...
  path = "http://private-s3.internal.paas:9000/cached-buildpacks/ruby_buildpack-cached-v1.8.10.zip"
  position = 35
  locked = false
  enabled = true
}
...
resource "cloudfoundry_buildpack" "nodejs-buildpack-offline" {
  ...
  path = "http://private-s3.internal.paas:9000/cached-buildpacks/nodejs_buildpack-cached-v1.7.13.zip"
  position = 35
  locked = false
  enabled = true
}
...
resource "cloudfoundry_buildpack" "go-buildpack-offline" {
  ...
  path = "http://private-s3.internal.paas:9000/cached-buildpacks/go_buildpack-cached-v1.9.7.zip"
  position = 36
  locked = false
  enabled = true
}
...
resource "cloudfoundry_buildpack" "python-buildpack-offline" {
  ...
  path = "http://private-s3.internal.paas:9000/cached-buildpacks/python_buildpack-cached-v1.7.8.zip"
  position = 37
  locked = false
  enabled = true
}
