resource "cloudfoundry_space" "coa-strimzi-smoke-tests-space" {
  name = "coa-strimzi-smoke-tests"
...
resource "cloudfoundry_space" "coa-strimzi-broker-space" {
  name = "coa-strimzi-broker"
