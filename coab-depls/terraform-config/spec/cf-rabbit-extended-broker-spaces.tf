resource "cloudfoundry_space" "coa-cf-rabbit-extended-smoke-tests-space" {
  name = "coa-cf-rabbit-extended-smoke-tests"
...
resource "cloudfoundry_space" "coa-cf-rabbit-extended-broker-space" {
  name = "coa-cf-rabbit-extended-broker"
