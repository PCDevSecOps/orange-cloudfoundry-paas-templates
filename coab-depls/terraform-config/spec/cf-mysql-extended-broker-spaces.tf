resource "cloudfoundry_space" "coa-cf-mysql-extended-smoke-tests-space" {
  name = "coa-cf-mysql-extended-smoke-tests"
...
resource "cloudfoundry_space" "coa-cf-mysql-extended-broker-space" {
