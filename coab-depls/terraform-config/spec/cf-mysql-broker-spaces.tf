resource "cloudfoundry_space" "coa-cf-mysql-smoke-tests-space" {
  name = "coa-cf-mysql-smoke-tests"
...
resource "cloudfoundry_space" "coa-cf-mysql-broker-space" {
  name = "coa-cf-mysql-broker"
