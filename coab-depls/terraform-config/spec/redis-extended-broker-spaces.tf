resource "cloudfoundry_space" "coa-redis-extended-smoke-tests-space" {
  name = "coa-redis-extended-smoke-tests"
...
resource "cloudfoundry_space" "coa-redis-extended-broker-space" {
