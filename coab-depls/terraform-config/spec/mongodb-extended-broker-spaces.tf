resource "cloudfoundry_space" "coa-mongodb-extended-smoke-tests-space" {
  name = "coa-mongodb-extended-smoke-tests"
...
resource "cloudfoundry_space" "coa-mongodb-extended-broker-space" {
  name = "coa-mongodb-extended-broker"
