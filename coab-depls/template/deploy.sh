...
uploadRelease "tgz" "prometheus-addons" "https://github.com/jraverdy-orange/prometheus-addons-boshrelease/releases/download/v3.1.0/prometheus-addons-v3.1.0.tgz" "3.1.0"