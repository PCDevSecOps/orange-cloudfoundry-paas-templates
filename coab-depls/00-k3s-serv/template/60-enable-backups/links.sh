...
ln -sf  ../../../../shared-operators/shield/add-shield-import-systems-pxcbackup-errand-operators.yml 40-shieldv8-add-shield-import-asystems-pxcbackup-errand-operators.yml
...
ln -sf ../../../../shared-operators/shield/shieldv8-vars.yml common-shieldv8-vars.yml
